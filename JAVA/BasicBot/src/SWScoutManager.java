...
public class SWScoutManager {
	...
	private static SWScoutManager instance = new SWScoutManager();
	
	/// static singleton 객체를 리턴합니다
	public static SWScoutManager Instance() {
		return instance;
	} 
...
//					Unit unit = WorkerManager.Instance().getClosestMineralWorkerTo(firstBuilding.getPosition());
	...
	// 정찰유닛부대를 지정해서 모든 베이스지역에 정찰시작
	public ArrayList<BaseLocation> allBaseLocationScout() {
